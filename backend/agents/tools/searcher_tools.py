...
def shodan_search(target: str, api_key: str | None = None) -> dict[str, Any]:
    ...
    from backend.modules.shodan_recon import shodan_recon as _mod  # type: ignore
    from backend.modules.shodan_recon import shodan_search as _run  # fallback
...
def censys_search(target: str, api_id: str | None = None, api_secret: str | None = None) -> dict[str, Any]:
    ...
    from backend.modules.censys_recon import censys_search as _run
...
def scrape_urls(urls: list[str], max_workers: int = 5) -> dict[str, Any]:
    ...
    from backend.modules.scraper import scrape_urls as _run
...
def xrecon_search(query: str, query_type: str = "username") -> dict[str, Any]:
    ...
    try:
        from backend.modules.xrecon import xrecon_search as _run
