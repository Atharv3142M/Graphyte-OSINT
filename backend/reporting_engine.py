...
**Generated:** {now}
**Platform:** OSINT Digital Footprint Visualizer
...
*This report was generated automatically by the OSINT Digital Footprint Visualizer.*
...
"""
    ...
    md += "\n---"
    md += "\n*Generated by OSINT Digital Footprint Visualizer — for authorized security research only.*\n"
    return md
